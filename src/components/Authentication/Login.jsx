    ...
    <div >
      ...
      <div className="loginpage">
          ...
          <div className="form-box login">
            <form action="#">
            <Lottie options={defaultOptions} height={100} width={100}  style={{marginRight:'440px', marginBottom:"10px"}} />
              <h3>Welcome Back To S3Y</h3>

              <h5>you login as..?</h5>
             <div className="usertypebtns">
                <button
                  onClick={(e) => { handleTypeClick("Developer", e) }}
                  className="usretypeButton"
                  value="developer"
                  style={{
                    backgroundColor: selectedType === 'Developer' ? '#164863' : 'white',
                ...
                <button
                  onClick={(e) => { handleTypeClick("skilledworker", e) }}
                  className="usretypeButton"
                  name="skilledworker"
                  style={{
                    backgroundColor: selectedType === 'skilledworker' ? '#164863' : 'white',
                    color: selectedType === 'skilledworker' ? 'white' : '#164863',
                  }}
                >
               Skilled Worker
                </button>
                <button
                  onClick={(e) => {handleTypeClick("User", e) }}
                  className="usretypeButton"
                  value="normaluser"
                  style={{
                    backgroundColor: selectedType === 'User' ? '#164863' : 'white',
                    color: selectedType === 'User' ? 'white' : '#164863',
                  }}
                >
               User
                </button>
